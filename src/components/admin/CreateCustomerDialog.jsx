// src/components/admin/CreateCustomerDialog.jsx
...
const CreateCustomerDialog = ({ open, onOpenChange }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    personalDetails: {
      ...
      education: '',
      maritalStatus: '',
      businessOrJob: '', // This will be set to undefined if empty to avoid enum validation error
      nameOfBusinessJob: '',
      typeOfDuty: '',
      annualIncome: '',
      panNumber: '',
        ...
        {createCustomerMutation.error && (
          <Alert variant="destructive" className="border-red-300/50 bg-red-500/20 backdrop-blur-sm">
            ...
            <AlertDescription className="text-red-200">
              {createCustomerMutation.error.message || 'Failed to create customer. Please try again.'}
            </AlertDescription>
          </Alert>
        )}
            ...
            <TabsContent value="personal" className="space-y-6">
              <Card className="bg-white/5 border-white/20">
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Additional Personal Details - ADDED MISSING FIELDS */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
