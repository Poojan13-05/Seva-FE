// src/components/admin/VehicleInsuranceTable.jsx
    ...
    return (
      <div className="border rounded-lg p-8 text-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900">No Vehicle Insurance Policies Found</h3>
            <p className="text-gray-500 mt-1">Create your first vehicle insurance policy to get started.</p>
          </div>
        </div>
      </div>
    );
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-white/10 border-white/10">
            <TableHead className="font-semibold text-gray-300">Policy Number</TableHead>
            ...
            <TableHead className="font-semibold text-gray-300">Policy Type</TableHead>
            <TableHead className="font-semibold text-gray-300">Registration Number</TableHead>
            <TableHead className="font-semibold text-gray-300">Start Date</TableHead>
            <TableHead className="font-semibold text-gray-300">End Date</TableHead>
              ...
              <TableRow key={policy._id} className="border-white/10">
                ...
                <TableCell>
                  ...
                  <div className="text-xs text-gray-400 mt-1">
                    {policy.vehicleDetails?.vehicleType || 'N/A'}
                  </div>
                </TableCell>

                <TableCell>
                  <div className="font-medium text-sm text-white">
                    {policy.vehicleDetails?.registrationNumber || 'N/A'}
                  </div>
                  <div className="text-xs text-gray-400">
                    {policy.vehicleDetails?.engineNumber ? `Engine: ${policy.vehicleDetails.engineNumber.substring(0, 10)}...` : 'N/A'}
                  </div>
                </TableCell>

                <TableCell>
                  <div className="text-sm text-white">
                    {formatDate(policy.insuranceDetails?.policyStartDate)}
                  </div>
                </TableCell>

                <TableCell>
                  <div className="text-sm text-white">
                    {formatDate(policy.insuranceDetails?.policyEndDate)}
                  </div>
                </TableCell>
...
export default VehicleInsuranceTable;
