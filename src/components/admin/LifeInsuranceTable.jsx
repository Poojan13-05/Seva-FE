// src/components/admin/LifeInsuranceTable.jsx
    ...
    return (
      <div className="border rounded-lg p-8 text-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900">No Life Insurance Policies Found</h3>
            <p className="text-gray-500 mt-1">Create your first life insurance policy to get started.</p>
          </div>
        </div>
      </div>
    );
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-white/10 border-white/10">
            ...
            <TableHead className="font-semibold text-gray-300">Policy Date</TableHead>
              ...
              <TableRow key={policy._id} className="border-white/10">
                ...
                <TableCell>
                  <div className="space-y-1">
                    ...
                    <div className="text-xs text-gray-400">
                      Insured: {policy.clientDetails?.insuredName || 'N/A'}
                    </div>
                  </div>
                </TableCell>
                ...
                <TableCell>
                  <div className="space-y-1">
                    <div className="text-sm text-white">
                      {formatDate(policy.insuranceDetails?.policyDate)}
                    </div>
                    <div className="text-xs text-gray-400">
