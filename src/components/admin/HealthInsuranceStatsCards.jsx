// src/components/admin/HealthInsuranceStatsCards.jsx
...
import { useHealthInsuranceStats } from '@/hooks/useHealthInsurance';

const HealthInsuranceStatsCards = () => {
  const { data, isLoading, error } = useHealthInsuranceStats();
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
        <Card className="bg-white/10 backdrop-blur-md border-white/20 col-span-full">
          <CardContent className="flex items-center justify-center py-8">
            <p className="text-red-400">Failed to load health insurance statistics</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  const statsCards = [
    {
      ...
      description: "Active health insurance policies"
    },
    {
      title: "New Policies",
...
export default HealthInsuranceStatsCards;
